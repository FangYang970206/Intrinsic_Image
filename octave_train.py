...
def main():
    ...
    parser.add_argument('--save_path',          type=str,   default='MPI_logs\\RIID_mish_ranger_Octave_one_bs10_updateLR1_epoch240_CosBF_VGG0.1_refl_SceneSplit\\',
    ...
    trainer = RIN_pipeline.OctaveTrainer(composer, train_loader, args.lr, device, writer, mode=args.mode, choose=args.choose)
    ...
    for epoch in range(cur_epoch, args.num_epochs):
        ...
        if args.mode == 'two':
            ...
            average_loss = RIN_pipeline.MPI_test_unet_one(composer, test_loader, device, choose=args.choose)
