...
class Decomposer(nn.Module):
    def __init__(self,
        ...
        refl_channels = [3, 16, 32, 64, 64, 128]
        shap_channels = [3, 16, 32, 64, 64, 128]
        ...
        self.lights_fc1 = nn.Linear(128, 32)
...
class Shader(nn.Module):
    def __init__(self,
        ...
        self.lights_fc = nn.Linear(lights_dim, 27 * 64)
    ...
    def forward(self, x, lights):
        ...
        lights = lights.view(-1, 1, 27, 64)
        
        ## concatenate shape and lights representations
        # print(encoded[-1].size())
