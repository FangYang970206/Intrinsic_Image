...
class MIT_TrainerOrigin:
    ...
    def _epoch(self):
        ...
        for _, labeled in enumerate(self.loader):
            ...
            lab_inp_pred, lab_refl_pred, lab_shad_pred, shape_pred = self.model.forward(input_g)
            ...
            # refl_loss = refl_bf_loss + refl_cos_loss + refl_content_loss*0.01 + refl_mse_loss * 5
            ...
            shad_loss = shad_bf_loss + shad_content_loss*0.1 + shape_cos_loss + shad_mse_loss
