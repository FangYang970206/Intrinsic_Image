...
class Unet_TrainerOrigin:
    def __init__(self, model, loader, lr, device, writer):
        ...
        parameters1 = []
        parameters2 = []
        parameters1.append( {'params': self.model.encoder2.parameters(), 'lr': lr} )
        parameters1.append( {'params': self.model.decoder_shading.parameters(), 'lr': lr} )
        parameters2.append( {'params': self.model.encoder1.parameters(), 'lr': lr} )
        parameters2.append( {'params': self.model.decoder_reflectance.parameters(), 'lr': lr} )
