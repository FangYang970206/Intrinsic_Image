...
def main():
    ...
    if args.checkpoint:
        ...
        cur_epoch = cur_epoch = int(args.state_dict.split('_')[-1].split('.')[0]) + 1
    ...
    trainer = RIN_pipeline.MPI_TrainerOriginRemoveShape(composer, train_loader, args.lr, device, writer)
    ...
    for epoch in range(cur_epoch, args.num_epochs):
        ...
        albedo_test_loss, shading_test_loss = RIN_pipeline.MPI_test_remove_shape(composer, test_loader, device)
