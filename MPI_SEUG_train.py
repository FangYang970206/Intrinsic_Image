...
def main():
    ...
    if args.data_augmentation:
        ...
        MPI_Scene_Split_train_txt = 'D:\\fangyang\\intrinsic_by_fangyang\\MPI_TXT\\MPI_main_sceneSplit-300-train.txt'
    else:
    ...
    cur_epoch = 0
    if args.checkpoint:
        reflectance.load_state_dict(torch.load(os.path.join(args.save_path, args.state_dict_refl)))
        shading.load_state_dict(torch.load(os.path.join(args.save_path, args.state_dict_shad)))
