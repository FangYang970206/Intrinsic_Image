...
def main():
    ...
    parser.add_argument('--save_path',          type=str,   default='logs_shapenet\\RIN_CosBF_VGG0.1_updateLR\\',
    ...
    parser.add_argument('--supervision_set_size',     type=int,   default=94938)
    ...
    parser.add_argument('--state_dict',         type=str,   default='composer_state_26.t7')
    ...
    if args.mode == 'train':
        if args.dataset == "ShapeNet":
            ...
            supervision_train_set = RIN_pipeline.BOLD_Dataset(args.data_path, size_per_dataset=args.supervision_set_size, mode='train', img_size=args.img_resize_shape)
            sv_train_loader = torch.utils.data.DataLoader(supervision_train_set, batch_size=args.batch_size, num_workers=args.loader_threads, shuffle=True)
            test_set = RIN_pipeline.BOLD_Dataset(args.data_path, size_per_dataset=20, mode='test', img_size=args.img_resize_shape)
            test_loader = torch.utils.data.DataLoader(test_set, batch_size=1, num_workers=args.loader_threads, shuffle=False)
