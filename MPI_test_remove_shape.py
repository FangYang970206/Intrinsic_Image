...
def main():
    ...
    parser.add_argument('--save_path',          type=str,   default='MPI_logs\\RIID_origin_RIN_updateLR_CosBF_VGG0.1_shading_epoch240_ImageSplit_size256_remove_shape\\',
    ...
    parser.add_argument('--state_dict',         type=str,   default='composer_state_222.t7')
