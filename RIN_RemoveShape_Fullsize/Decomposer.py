...
class Decomposer(nn.Module):
    ...
    def __init__(self, lights_dim = 4):
        ...
        self.lights_fc1 = nn.Linear(16 * 7 * 16, 32)
    ...
    def forward(self, inp):
        ...
        return self.remove_padding(reflectance), lights, encoded2


if __name__ == '__main__':
    inp = Variable(torch.randn(5,3,436,1024))
    # mask = Variable(torch.randn(5,3,256,256))
    decomposer = Decomposer()
    refl, lights,  _ = decomposer.forward(inp)
    print(refl.size())
    print(lights.size())
